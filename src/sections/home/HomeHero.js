              ...
              <m.div variants={varFade().inRight}>
                <TextIconLabel
                  icon={
                    <Image
                      alt="sketch icon"
                      src="https://minimals.cc/assets/images/home/ic_sketch_small.svg"
              ...
              <m.div variants={varFade().inRight}>
                <TextIconLabel
                  icon={
                    <Image
                      alt="sketch icon"
                      src="https://minimals.cc/assets/images/home/ic_figma_small.svg"
                      sx={{ width: 20, height: 20, mr: 1 }}
                    />
                  }
                  value={
                ...
                {["ic_sketch", "ic_figma", "ic_js", "ic_ts", "ic_nextjs"].map(
                  (resource) => (
                    <m.img
                      ...
                      src={`https://minimals.cc/assets/images/home/${resource}.svg`}
                    />
                  )
                )}
              </Stack>
