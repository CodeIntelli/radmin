    ...
    <RootStyle>
      <Container sx={{ position: "relative" }}>
        <Image
          ...
          disabledEffect
          alt="image shape"
          src="https://minimals.cc/assets/images/home/shape.svg"
          sx={{
            top: 0,
            right: 0,
            bottom: 0,
          ...
          <Grid item xs={12} md={7} sx={{ position: "relative" }}>
            <MotionInView threshold={0.5} variants={varFade().inUp}>
              <Image
                disabledEffect
                alt="light mode"
                src="https://minimals.cc/assets/images/home/lightmode.png"
              />
            </MotionInView>
            ...
            >
              <Image
                disabledEffect
                alt="dark mode"
                src="https://minimals.cc/assets/images/home/darkmode.png"
              />
            </MotionInView>
          </Grid>
        </Grid>
