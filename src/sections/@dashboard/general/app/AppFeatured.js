...
const Appdata = [
  {
    ...
    image: 'https://minimal-assets-api.vercel.app/assets/images/feeds/feed_1.jpg',
    title: 'Harry Potter and the Deathly Hallows - Part 2',
  },
  {
    description: 'Believing These 7 Myths About Event Keeps You From Growing',
    id: 'e99f09a7-dd88-49d5-b1c8-1daf80c2d7b2',
    image: 'https://minimal-assets-api.vercel.app/assets/images/feeds/feed_2.jpg',
    title: 'Disney Zombies 2',
  },
  {
    description: "Don't Waste Time! 7 Facts Until You Reach Your Event",
    id: 'e99f09a7-dd88-49d5-b1c8-1daf80c2d7b3',
    image: 'https://minimal-assets-api.vercel.app/assets/images/feeds/feed_3.jpg',
...
export default function AppFeatured() {
  ...
  console.log(Appdata);
  const [currentIndex, setCurrentIndex] = useState(theme.direction === 'rtl' ? Appdata.length - 1 : 0);
